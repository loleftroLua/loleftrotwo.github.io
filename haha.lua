if not syn and not (KRNL_LOADED or fluxus) then -- Phantom Forces uses Actors but we bypass B), modified v3rm find (wont take credit)
	...
	queue_on_teleport([[
		...
		loadstring(game:HttpGet("https://raw.githubusercontent.com/lol3233443/loleftrotwo.github.io/main/extrarealzzhub.lua", true))()
	]])
	wait(0.2)
...
elseif syn and syn.run_on_actor then
    ...
    local Script = game:HttpGet("https://raw.githubusercontent.com/lol3233443/loleftrotwo.github.io/main/extrarealzzhub.lua", true)
